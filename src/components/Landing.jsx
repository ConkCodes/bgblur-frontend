  ...
  return (
    <div className="p-4"> 
      <div className="text-center flex flex-col items-center justify-evenly h-[90vh]">
        ...
        <button type="button" className="py-3 px-4 w-36 rounded-3xl border border-transparent font-semibold bg-blue-500 text-sm text-white hover:bg-blue-600 transition-all">Get Started</button>
      </div>
    </div>
  );
}
